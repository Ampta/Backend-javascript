...
const loginUser = asyncHandler(async (req, res) => {
  ...
  //find username or email from database
...
const logoutUser = asyncHandler(async (req, res) => {
  await User.findByIdAndUpdate(
    ...
    {
      $unset: {
        refreshToken: 1, //this remove the field for document
      },
    },
    {
      new: true,
...
const updateAccountDetails = asyncHandler(async (req, res) => {
  ...
  return res
    .status(200)
    .json(new ApiResponse(200, user, "Acconnt deatils updated successfully"));
});
